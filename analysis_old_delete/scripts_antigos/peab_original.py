...
DATASET_CONFIG = {
    ...
    # Datasets de Alta Dimensionalidade - subsample_size reduzido para viabilidade
    # PuLP vai estourar mesmo com subamostra pequena devido às 10k-47k variáveis binárias
    "newsgroups":           {'subsample_size': 0.1, 'test_size': 0.3, 'rejection_cost': 0.24},  # ~700 instâncias
    "rcv1":                 {'subsample_size': 0.05, 'test_size': 0.3, 'rejection_cost': 0.24},  # ~500 instâncias
}
