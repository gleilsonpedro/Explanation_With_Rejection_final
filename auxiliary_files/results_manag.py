...
RESULTS_FILE = "comparative_results.json"
...
def update_method_results(method: str, dataset: str, results: Dict[str, Any]) -> None:
    ...
    Args:
        method: 'peab', 'anchor' ou 'mateus'
        dataset: nome do dataset (ex: 'iris')
        results: dicionário com as métricas do dataset
    """
    all_results = load_results()
    all_results[method][dataset] = results
    save_results(all_results)
    print(f"Resultados atualizados: {method} - {dataset}")