#VER SE AINDA FAZ SENTIDO MANTER ESTE SCRIPT ATIVO , ACHO QUE FOI SUBSTITUIDO PELO PEAB VS PULP
# 
...
def executar_benchmark():
    ...
    norm_params = model_params['norm_params']
    ...
    with ProgressBar(total=len(X_test), description=f"Comparando {dataset_name}") as pbar:
        for i in range(len(X_test)):
            ...
            expl_peab, _, _, _ = gerar_explicacao_instancia(instancia, modelo, X_train, t_plus, t_minus, norm_params, benchmark_mode=True)
